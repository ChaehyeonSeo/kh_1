...
public class Demo {
	...
	public static void main(String[] args) {
		 ...
		 * 		다른 점은 모든 메서드가 추상 메서드이고 멤버 변수는
		 * 		오직 상수만을 가질 수 있다.
		 * 
		 *	  - 모든 메서드는 암묵적으로 public abstract이다.
		 *	  - 멤버 변수는 암묵적으로 public static final이다.
		...
		System.out.println(pArr[1] instanceof Staff);
		System.out.println(pArr[1] instanceof Member);

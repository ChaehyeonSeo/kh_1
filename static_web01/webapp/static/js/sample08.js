 ...
 *      문제가 있는 경우 붉은색 테두리와 에러 메시지로,
 *      정상 입력인 경우 초록색 테두리와 정상 메시지로 사용자에게
 *      즉시 알릴 수 있도록 한다.
 * 
 *      패스워드는 4 ~ 12자 사이의 값을 입력하였는지 실시간으로 검사하여
 *      위의 아이디와 동일한 처리
 * 
 *      패스워드 확인은 기존에 입력한 패스워드와 동일한 값인지를 
 *      실시간으로 검사하여 위의 아이디와 동일한 처리
 */

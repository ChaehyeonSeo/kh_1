...
ALTER TABLE EMP_SAMPLE MODIFY EMAIL DEFAULT(NULL);
ALTER TABLE EMP_SAMPLE MODIFY COMMISSION_PCT DEFAULT(NULL);
ALTER TABLE EMP_SAMPLE MODIFY PHONE DEFAULT(NULL);

...
public class Demo01 {
	...
	public static void main(String[] args) {
		 ...
		 * 		저장된 값마다 인덱스가 부여되며, 인덱스 번호는 0부터 시작
		 * 		
		 * 	배열 선언
		 * 		int 변수명[];
		 * 		int[] 변수명;
		 ...
		 * 
		 * 	배열 공간만 생성하는 경우 모든 공간은 기본값으로 초기화
		 * 		정수 -> 0
		 * 		실수 -> 0.0
		 * 		불린 -> false
		 * 		문자열 -> null
		 * 
		 * 	배열 공간의 크기를 알기 위해서는 length 속성 사용
		 * 
		 * 	배열에 저장된 값을 추출하거나 할당하기 위해서는 인덱스를 활용한다.
		 * 		변수명[인덱스]
		 * 
		...
		int arr2[] = {1,2,3};		// 공간 생성 후 지정된 값으로 초기화
...
//		배열의 모든 값을 탐색하여 출력
		 ...
		 *					참조 주소만 복사를 했기 때문에 실제로 사용하는 데이터는 동일
		 *

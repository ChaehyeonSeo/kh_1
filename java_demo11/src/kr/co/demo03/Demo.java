...
public class Demo {
	...
	public static void main(String[] args) {
		 ...
		 * 	  - 주로 프로퍼티 파일을 읽어 그 안의 속성을 
		 * 		프로그램에서 사용할 수 있게 만들기 위해 쓰인다.
		 * 	  - 프로퍼티 파일은 주로 어플리케이션이 동작하는 과정에서 
		 * 		어플리케이션 초기 동작에 필요한 값이나 설정값을 변경하여 
		 * 		내부 동작이 다르게 이루어질 수 있도록 하기 위한 용도로 사용하는 파일이다.
		 * 		(어플리케이션이 처음 동작할 때 데이터베이스 연결과 관련된 
		 * 		프로퍼티 파일을 읽어서 연결을 시도)
		 */

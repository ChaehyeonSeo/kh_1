...
public class Exam {
	...
	public static void main(String[] args) {
		...
		subjectMap.put("국어", new Subject(96.4, 'A'));
		subjectMap.put("영어", new Subject(81.2, 'B'));
		subjectMap.put("수학", new Subject(98.2, 'A'));
		subjectMap.put("사회", new Subject(72, 'C'));
		subjectMap.put("과학", new Subject(89.7, 'B'));
		subjectMap.put("체육", new Subject(68.1, 'D'));

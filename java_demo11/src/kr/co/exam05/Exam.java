...
public class Exam {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 	HashMap을 기본으로 Key에는 Student 클래스를 사용하고
		 * 	Value에는 ArrayList를 사용하도록 한다.
		 * 	그리고 ArrayList에 Subject 클래스를 담아 사용하도록 한다.
		 * 	
		 * 	성적 관리 프로그램으로 관리하는 모든 정보는 파일에 저장하여
		 * 	다음번에 다시 프로그램을 실행했을 대 이전 상태가 저장되어 있어야 한다.

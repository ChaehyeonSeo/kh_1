...
public class Exam {
	...
	public static void main(String[] args) {
		/*
		 * 파일에 저장된 성적 데이터를 읽고 
		 * 프로그램에서 사용할 수 있는 Subject 객체로 변환한다.
		 * 변환된 Subject를 활용하여 데이터 추가 및 수정, 삭제를 진행 후
		 * 다시 동일한 파일에 저장할 수 있게 한다.
		 * 파일명은 "학생명.subjects"로 하며, 
		 * 파일에 작성된 데이터는 다음의 구조를 가진다.
		 * 
		 * 학생명.subjects
		 * 		과목명1 점수1 등급1
		 * 		과목명2 점수2 등급2
		 ...
		 * 
		 * Subject 클래스의 메서드로 
		 * toString(String delimiter) 메서드를 오버로딩하여
		 * delimiter를 구분자로 하는 문자열이 반환될 수 있도록 하세요.
		 * 

...
//		.print()는 개행(줄바꿈) 없이 한 줄에 계속 출력할 때 사용
//		.printf()는 .print() 기능에 특정 형식(포맷)을 갖추어 출력할 때 사용
//		.println()는 .print() 기능을 수행 후 개행(줄바꿈)을 추가할 때 사용
		...
		System.out.printf("%s / %d%n", "Hello", 1234);
		...
		System.out.printf("안녕하세요. 제 이름은 %s입니다. 나이는 %d세입니다.%n", name, age);
		
		System.out.println();
		System.out.println("println()은 문장열 내용이 전부 출력된 후에 줄바뀜이 이뤄짐'");
		System.out.println("중간 중간 원하는 위치에 줄바꿈");
		System.out.println("하기 위해서는 println()을");
		System.out.println("반복적으로 사용할 수 밖에 없음");
		
		System.out.println("내가 원한는 위치에 \n줄바꿈을 넣고 싶으면\n개행 문자인 역슬래쉬 + n 의");

...
public class Demo01 {
	...
	public static void main(String[] args) {
		/*
		 *	객체
		 *		현실 세계는 사물이나 개념처럼 독립되고 구분되는 각각의 
		 *		객체로 이루어져 있으며, 발생하는 모든 사건들은 객체 간의 
		 *		상호작용으로 이루어져 있다. 이러한 개념을 컴퓨터로 옮겨 
		 *		유사하게 동작하도록 만든 것을 객체지향 언어라고 한다.
		 *
		 *	예시
		 *		국가에서 국민 정보 관리용 프로그램을 만들려고 할 때 프로그램에서 
		 *		요구하는 "국민"이라는 한 사람의 정보를 객체화(추상화)한다면?
		 *
		 *		국민 : 이름, 나이, 성별, 전화번호, 주민등록번호, 주소, ...
		 *
		 *		국민객체
		 *			String 이름;
		 *			int 나이;
...
//		phone1.number = "010-4567-8975";
		...
		/*	
		 * 	생성자
		 * 		new 연산자를 통해 객체가 인스턴스로 만들어질 때 객체 안에서 
		 * 		만들어지는 멤버 변수를 초기화하기 위한 메서드
		 ...
		 * 		protected	: 같은 패키지, 후손 관계까지만 접근 가능
